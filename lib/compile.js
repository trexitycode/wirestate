 ...
 */
exports.compileFromText = async (text, wireStateFile, { srcDir = '', cacheDir = '.wirestate', generatorName = 'json', disableActions = false } = {}) => {
 ...
 * @param {boolean} [options.disableActions] Flag when generating XState to disable action mapping
 */
exports.compile = async (fileName, { srcDir = '', cacheDir = '.wirestate', generatorName = 'json', disableActions = false } = {}) => {
    const cache = new cache_1.Cache({ srcDir, cacheDir });
