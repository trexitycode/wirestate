 ...
 */
exports.compileFromText = async (text, wireStateFile, { srcDir = '', cacheDir = '.wirestate', generatorName = 'json', disableCallbacks = false } = {}) => {
 ...
 * @return {Promise<string>}
 */
exports.compile = async (fileName, { srcDir = '', cacheDir = '.wirestate', generatorName = 'json', disableCallbacks = false } = {}) => {
    const cache = new cache_1.Cache({ srcDir, cacheDir });
