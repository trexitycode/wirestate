 ...
 * @return {Promise<ScopeNode>}
 */
function requireWireStateFile(wireStateFile, { cache, srcDir = '' }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fileExists = yield FileSystem.fileExists(fileName);
        if (!fileExists) {
        ...
        yield cache.set(wireStateFile, promise);
        return promise;
    });
}
 ...
 * @param {string} [options.srcDir]
 */
function analyzeScopeNode(scopeNode, { cache, srcDir = '' }) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @param {string} [options.srcDir]
 */
function analyzeImportNode(importNode, { cache, srcDir = '' }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function analyzeUseDirectiveNode(useDirectiveNode, { cache }) {
    return __awaiter(this, void 0, void 0, function* () {
        if (useDirectiveNode) {
            ...
            if (!machineNode) {
                const importedScopeNodes = yield Promise.all(scopeNode.imports.map(importNode => cache.get(importNode.wireStateFile)));
