 ...
 * @return {Promise<ScopeNode>}
 */
function requireWireStateFile(wireStateFile, { dirs = [] }) {
 ...
 * @param {string[]} [options.dirs]
 */
function analyzeScopeNode(scopeNode, { dirs = [] } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @param {string[]} [options.dirs]
 */
function analyzeImportNode(importNode, { dirs = [] } = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        const fileToImport = importNode.file.startsWith('.')
            ? Path.join(importNode.parent.fileName, importNode.file)
            : importNode.file;
        importNode.scopeNode = yield requireWireStateFile(fileToImport, { dirs });
        return importNode;
    });
}
/**
