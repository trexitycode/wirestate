...
const parseImportNode = (scanner) => {
    ...
    const importNode = new ast_nodes_1.ImportNode(ids, wireStateFile);
...
const parseTransitionNode = (scanner) => {
    ...
    const node = new ast_nodes_1.TransitionNode(eventDescriptor, target);
    Object.assign(node, {
...
const parseStateNode = (scanner, { indentLevel }) => {
    ...
    const node = new ast_nodes_1.StateNode(idToken.value, indentLevel);
    Object.assign(node, {
        line: idToken.line,
